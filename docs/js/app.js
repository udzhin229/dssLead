(() => {
    ...
    function tabs() {
        ...
        function initTabs(tabsBlock) {
            ...
            } else if (tabsContent.length) tabsContent.forEach(((tabsContentItem, index) => {
        ...
        function setTabsAction(e) {
            ...
            if (el.closest("[data-tabs-title]")) {
                ...
                if (viewportWidth > mobileWidth && tabsBlock.classList.contains("tab-disabled-on-pc")) return;
